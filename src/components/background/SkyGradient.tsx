...
function SkyGradient() {
  return (
    <>
      ...
      <div className="absolute bottom-0 left-[50%] z-0 h-2/3 w-[150vw] -translate-x-[50%] bg-gradient-to-t from-orange-400/80 via-orange-400/50 via-[15%] to-80% dark:bg-radial-[at_50%_100%] dark:from-violet-100/50 dark:via-violet-500/30 dark:via-[10%] dark:to-60%" />
      <ForestSvg
        width={"100%"}
