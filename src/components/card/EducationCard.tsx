...
function EducationCard() {
  return (
    <div className="dark:divide-2 flex items-center justify-center gap-4 rounded-xl border-2 border-amber-900/40 bg-gradient-to-b from-yellow-700/40 to-yellow-700/20 p-4 max-lg:flex-col dark:border-none dark:bg-none">
